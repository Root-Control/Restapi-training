...
const tenant_model_1 = require("../helpers/tenant-model");
let TokenMiddleware = class TokenMiddleware {
    ...
    use(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (token) {
                try {
                    parsedToken = jsonwebtoken_1.verify(token, server_constants_1.SERVER_CONFIG.jwtSecret);
                    req.user = yield this.userModel.findById(parsedToken['_id']).select('-salt -password');

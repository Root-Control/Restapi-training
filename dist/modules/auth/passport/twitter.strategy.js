...
let TwitterStrategy = class TwitterStrategy {
    constructor(twitterConfig, connection) {
        this.twitterConfig = twitterConfig;
        this.connection = connection;
        this.init();
    }
    init() {
        passport_1.use('twitter', new TwitterTokenStrategy({
            ...
            try {
                ...
                const existingUser = yield this.userModel.findOne({ 'twitter.id': profile.id });
                if (existingUser) {
...
TwitterStrategy = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject(server_constants_1.TWITTER_CONFIG_TOKEN)),
